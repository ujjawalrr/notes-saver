...
const Home = () => {
  return (
    <div className='min-h-[calc(100vh-60px)] bg-gradient-to-tr from-[#d3baa9] to-[#ffc9aa]'>
      <div className="flex items-center justify-center px-2 py-4 lg:py-8">
        <div className="max-w-lg mx-auto p-5 sm:p-6 lg:p-8 bg-white rounded shadow-md">
          <h1 className="text-3xl font-bold mb-2 sm:mb-4">Welcome to Note Saver</h1>
          <p className="text-lg text-gray-700 mb-4 md:mb-8">A simple and efficient way to manage your notes!</p>
